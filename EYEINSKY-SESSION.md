...
**T6 (después):** elegir pose (Alex: solar o tilt), promover `skin=editorial` y `globe=editorial` a valores por defecto, reescribir en RED los dos literales de p4/mobile, regresión completa, medición n=3 en la GPD, capturas para Alex, release a staging.
